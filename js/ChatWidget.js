...
const ChatWidget = () => {
    ...
    return (
        <div className="font-sans antialiased">
            ...
            {/* Chat Window */}
            {isOpen && (
                <div className="fixed bottom-20 right-4 w-80 sm:w-96 h-[500px] bg-gray-900 rounded-2xl shadow-2xl flex flex-col overflow-hidden ring-1 ring-gray-700 animate-fade-in-up origin-bottom-right">
